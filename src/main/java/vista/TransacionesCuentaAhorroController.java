...
public class TransacionesCuentaAhorroController {
    ...
    void Depositar(ActionEvent event) {
        ...
        if(ValidarCampos(identificacion,numeroCuenta,Detalle,Monto)==true){
            if(BancoControlador.VerificarCuentaAhorro(identificacion,numeroCuenta)==true){
                String resultDeposito=BancoControlador.RealizarDepositoCuentaAhorro(identificacion,numeroCuenta,Detalle,Monto);
    ...
    void Retirar(ActionEvent event) {
        ...
        if(ValidarCampos(identificacion,numeroCuenta,Detalle,Monto)==true){
            if(BancoControlador.VerificarCuentaAhorro(identificacion,numeroCuenta)==true){
                String resultRetriro=BancoControlador.RealizarRetiroCuentaAhorro(identificacion,numeroCuenta,Detalle,Monto);
                Alert alert=new Alert(Alert.AlertType.INFORMATION);
